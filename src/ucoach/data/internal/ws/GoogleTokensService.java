 ...
 * 
 */
@WebServiceClient(name = "GoogleTokensService", targetNamespace = "http://ws.data.ucoach/", wsdlLocation = "http://192.168.0.102:6900/ws/google-tokens?wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://192.168.0.102:6900/ws/google-tokens?wsdl");
